...
from ...utils.sim import get_name, unpack_sim
from .types import (
    AggregatorFunc,
    Float,
    JsonDict,
...
# Pooling functions come from the statistics module or are built-in functions.
...
"""
The aggregator are the means by which local similarities are aggregated into a global similarity.

aggregator is passed to the attribute_value function to compute the similarity between two cases based on their attribute values.
"""
