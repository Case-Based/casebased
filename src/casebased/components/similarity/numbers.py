...
from .types import SimPairFunc, SupportsMetadata
...
"""
These are functions to compute local similarities between two numbers.

linear_interval: Linear similarity function based on the distance between two values within a range.
linear: Linear similarity function based on the distance between two values.
threshold: Threshold similarity function.
exponential: Exponential similarity function.
sigmoid: Sigmoid similarity function.
"""
