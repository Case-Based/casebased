# import case_base.casebase as casebase
import pytest 
import pandas as pd
...
class TestCaseBase:
    ...
    def test_setUp(self):
        ...
        assert case_base2 == case_base1.data
    ...
    def test_add_case(self):
        ...
        for column, expected_value in expected_values.items():
            assert last_row[column] == expected_value
    ...
    def test_update_case(self):
        ...
        for column, expected_value in expeceted_values.items():
            assert second_row[column] == expected_value
    ...
    def test_fill_up_emtpy_values_with_zero(self): 

        case_base = casebase.CaseBase(cb_type=CBTypes.DF.value, source=self.csv)

        case_base.fill_up_empty_values_with_zero()
    ...
    def test_return_case_base(self): 

        case_base = casebase.CaseBase(CBTypes.DF.value, source=self.csv_file_path_setup)
        ...
        current_case_base = case_base.get_case_base()

        for column, expected_value in expected_value.items():
            assert case_base.data[column].tolist() == expected_value