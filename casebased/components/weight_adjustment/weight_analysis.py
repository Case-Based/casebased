...
class FraudWeightAnalyzer:
    def __init__(self, model_path='casebased/components/weight_adjustment/logistic_model.pkl'):
    ...
    def preprocess_data(self, df):
        ...
        categorical_features = ['Sender_Country', 'Sender_Sector', 'Sender_lob', 'Bene_Country', 'Transaction_Type']
    ...
    def get_feature_weights(self):
        ...
        # Save weights
        weights_df.to_csv('casebased/components/weight_adjustment/feature_weights.csv', index=False)
