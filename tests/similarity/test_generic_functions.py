from casebased.components.similarity_measure.functions import Equality, Static, VectorDifference
...
test_cases_vector_distance = [
    { "x": [12, 1, 3], "y": [1, 25, 10], "result": 42.0, },
    { "x": [12, 1, 3], "y": [1, 25], "result": 38.0, },
]
